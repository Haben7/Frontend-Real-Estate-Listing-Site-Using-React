...
//                 </Button>
//                 </div>
//             <div className="d-flex flex-wrap justify-content-center" style={{ gap: '1rem', marginTop: '1%' }}>
            
//                 {cities.slice(startIndex, startIndex + citiesPerPage).map((cityItem, index) => (
//                     <Card
//                         key={index}
//                         style={{ width: '250px', height: '300px', cursor: 'pointer', borderRadius:'30px' }}
//                         onClick={() => handleCityClick(cityItem.name)}
//                         className="text-center"
//                     >
//                         <Card.Img 
//                             variant="top" 
//                             src='../public/square-beautiful-border-296x300.jpg' 
